...
import { XMarkIcon, CheckIcon, ExclamationCircleIcon } from '@heroicons/react/24/solid';
    ...
    return(
        ...
        (<div className='fixed top-20 left-1/3'>
            <div className={toastStyles}>
                {status === "Confirmed" ? <><CheckIcon className='h-8 w-8 text-green-500'/>
                <p>Success! You are confirmed.</p></> : null}
                {status === "Declined" ? <><ExclamationCircleIcon className='h-8 w-8 text-red-500'/>
                <p>Offer declined.</p></> : null}
